...
Lanyard is a service that we use to attach stream information to a Discord account. To do this, we only need 2 pieces of information: your Discord ID and your Lanyard API key. Read the next sections to learn how to get these.
...
Go to the [Settings page](https://streamaze.live/settings) from the Dashboard sidebar and find the Lanyard API section near the bottom. Paste your Discord ID and Lanyard API key into the fields and click Save. This enables the Streamaze widgets to function properly.
