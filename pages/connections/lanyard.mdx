...
Go to the [Settings page](https://streamaze.xyz/settings) from the Dashboard sidebar and find the Lanyard API section near the bottom. Paste your Discord ID and Lanyard API key into the fields and click Save.
