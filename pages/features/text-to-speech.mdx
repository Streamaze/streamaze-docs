...
Navigate to the [Streamaze Settings page](https://streamaze.xyz/settings) and find the Donation Settings. From there, find the TTS Service dropdown and select the TTS service you wish to use.
...
![ElevenLabs Voices](/images/tts/elevenlabs-voices.png)
