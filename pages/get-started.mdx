...
The [Streamaze Dashboard](https://streamaze.live/dashboard) is where you'll view your live stream chats, donations, and more. With the Premium plan you'll also be able to control OBS from the Dashboard. The Dashboard can be accessed by browser or tablet as long as there's an internet connection.

**insert image here**

## Configure Your Dashboard

To configure the things shown on the Dashboard, go the Settings page from the sidebar and adjust the settings to your needs. The following paragraphs break down each section of the Settings page in order.
...
If you want to quickly timestamp moments from the live stream, you'll need to configure this section.
...
Connecting to Streamlabs also enabled TTS features. Read more about [TTS here](/features/tts).
